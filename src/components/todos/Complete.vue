<template>
    <div>
        <Table>
            <tr class="bg-white" v-for='todo in completeTodos' :key='todo.id'>
        ...
        <Mobile>
            <div class="bg-white space-y-3 p-4 rounded-lg shadow" v-for='todo in completeTodos' :key='todo.id' :class="{active : todo.isComplete}">
